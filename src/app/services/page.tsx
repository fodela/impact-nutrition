  ...
  return <main>
    <div className="max-w-screen-xl p-4 md:p-2  md:mx-auto">
      <div className="block md:grid grid-cols-2  gap-8  sm:grid-cols-1 text-2xl p-2  md:grid-cols-2">
        <Image src='https://impactnutritionconsult.com/assets/Images/Rectangle 30.png' width={600} height={100} alt="img hero" />
        <div className="mt-20">
      ...
      <div className="max-w-screen-xl p-4 md:p-2  md:mx-auto">
        ...
        <div className="block md:grid grid-cols-2 mt-14 gap-10 sm:grid-cols-1 text-2xl p-2  md:grid-cols-2">
          <div className=" grid place-items-center text-center">
            <Image className="" src='https://impactnutritionconsult.com/assets/Images/service-1.png' width={100} height={100} alt="img hero" />
          ...
          <div className=" grid place-items-center text-center">
            <Image src='https://impactnutritionconsult.com/assets/Images/service-2.png' width={100} height={100} alt="img hero" />
            <h2>Simply dummy text</h2>
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Modi nesciunt, ab non cum voluptas molestias.</p>
          </div>

          <div className=" grid place-items-center text-center">
            <Image src='https://impactnutritionconsult.com/assets/Images/service-3.png' width={100} height={100} alt="img hero" />
            <h2>Simply dummy text</h2>
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Modi nesciunt, ab non cum voluptas molestias.</p>
          </div>

          <div className=" grid place-items-center text-center">
            <Image src='https://impactnutritionconsult.com/assets/Images/service-4.png' width={100} height={100} alt="img hero" />
            <h2>Simply dummy text</h2>
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Modi nesciunt, ab non cum voluptas molestias.</p>
          </div>
