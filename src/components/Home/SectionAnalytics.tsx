...
const SectionAnalytics = () => {
  return (
    <section className="dark:bg-black bg-blue-100 pt-8 md:pb-24">
      <div className="max-w-screen-xl px-2 md:mx-auto">
        ...
        <p className="text-center text-2xl mx-auto my-6 max-w-screen-lg bg-white dark:bg-black rounded-lg py-8">
        ...
        <div className="section_grid">
          <div className="flex flex-col justify-center items-center p-4 bg-white dark:bg-black rounded-lg shadow-sm gap-4">
