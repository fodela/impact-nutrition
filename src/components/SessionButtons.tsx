  ...
  if (session) {
    return (
      <div className="relative">
        ...
        {
          showAction && <div className="absolute w-48 mx-2 mt-3 right-6 rounded-xl bg-gray-200 shadow-md px-4 py-2">
            <ul>
              <li className="mb-1 font-bold relative">
                <Link className="btn-effect" href="/profile"> Profile
                  <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-green-400 transition-all duration-300 opacity-0"></span>
                </Link></li>
              <li className="mb-1 font-bold relative">
                <Link className="btn-effect" href="/profile"> Create Post
                  <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-green-400 transition-all duration-300 opacity-0"></span>
                </Link></li>
              <li className="mb-1 font-bold relative">
                <Link className="btn-effect" href="/profile"> Add CPD event
                  <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-green-400 transition-all duration-300 opacity-0"></span>
                </Link></li>
            </ul>
